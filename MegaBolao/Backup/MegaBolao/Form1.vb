...
#Region " Eventos da Classe "
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ToolStripStatusLabel1.Text = My.Application.Info.Copyright & " " & _
                                     Application.CompanyName & IIf(Year(Now) > 2010, "-" & Year(Now), "")
    ...
    Private Sub Apuracao()
        ...
        For Each oCnt As Control In grpApostas.Controls
            If oCnt.Name Like "pr*" Then
                ...
                oCnt.Text = Microsoft.VisualBasic.Switch(intP(i) < 4, "-", intP(i) = 4, "QUADRA", intP(i) = 5, _
                                    "QUINA", intP(i) = 6, "* M E G A *")
                intPremios += IIf(oCnt.Text.Contains("A"), 1, 0)
            End If
        Next

        If (Trim(pr01.Text) & Trim(pr02.Text) & Trim(pr03.Text) & Trim(pr04.Text) & Trim(pr05.Text) & _
    ...
    Private Sub GravaGerador(ByVal strFilename As String)
        ...
        For i As Integer = 1 To CType(txtGerador.Text, Integer)
            ...
            If aApostas.Count > 0 Then
                aApostas.Sort()
                stmApostas.WriteLine(aApostas(0) & ";" & aApostas(1) & ";" & aApostas(2) & ";" & aApostas(3) & ";" & _
